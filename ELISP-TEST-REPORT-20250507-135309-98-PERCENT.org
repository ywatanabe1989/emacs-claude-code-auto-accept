...
#+AUTHOR: ywatanabe
#+DATE: 2025-05-07 13:53:14 Created by https://github.com/ywatanabe1989/emacs-test
...
- [[file:tests/test-ecc-start-stop.el::test-ecc-auto-loadable][test-ecc-auto-loadable]]
- [[file:tests/test-ecc-start-stop.el::test-ecc-auto-toggle-defined][test-ecc-auto-toggle-defined]]
- [[file:tests/test-ecc-start-stop.el::test-ecc-auto-toggle-starts-when-inactive][test-ecc-auto-toggle-starts-when-inactive]]
- [[file:tests/test-ecc-start-stop.el::test-ecc-auto-toggle-stops-when-active][test-ecc-auto-toggle-stops-when-active]]
- [[file:tests/test-ecc-start-stop.el::test-ecc-buffer-rename-buffer-when-enabled][test-ecc-buffer-rename-buffer-when-enabled]]
- [[file:tests/test-ecc-start-stop.el::test-ecc-buffer-rename-buffer-when-disabled][test-ecc-buffer-rename-buffer-when-disabled]]
- [[file:tests/test-ecc-start-stop.el::test-ecc-auto-enable-uses-current-buffer-when-no-buffer-exists][test-ecc-auto-enable-uses-current-buffer-when-no-buffer-exists]]
  + Error details:
...
- [[file:tests/test-ecc-start-stop.el::test-ecc-auto-enable-adds-hook-and-starts-timer][test-ecc-auto-enable-adds-hook-and-starts-timer]]
- [[file:tests/test-ecc-start-stop.el::test-ecc-auto-disable-removes-hook-and-cancels-timer][test-ecc-auto-disable-removes-hook-and-cancels-timer]]
- [[file:tests/test-ecc-start-stop.el::test-ecc-auto-check-and-restart-adds-hook-when-missing][test-ecc-auto-check-and-restart-adds-hook-when-missing]]
- [[file:tests/test-ecc-start-stop.el::test-ecc-auto-check-and-restart-finds-vterm-buffer-when-needed][test-ecc-auto-check-and-restart-finds-vterm-buffer-when-needed]]
  + Error details:
