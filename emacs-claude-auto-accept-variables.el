...
;;; Author: root
;;; Timestamp: <2025-05-04 22:54:48>
;;; File: /root/.emacs.d/lisp/claude/emacs-claude-auto-accept-variables.el
...
;; (defvar emacs-claude-prompt-y/n "❯ 1. Yes"
;;   "Y/n prompt shown in claude code"
;;   :type 'string
;;   :group 'emacs-claude)

;; (defcustom emacs-claude-prompt-waiting
;;   "│ > "
;;   "Waiting prompt shown in claude code"
;;   :type 'string
;;   :group 'emacs-claude)
